...
<html lang="en">
    ...
    <body class="flex justify-center items-center h-screen" style="background: url('../resx/background.jpg');">
        <div class="flex flex-col justify-center items-center w-[557px] h-[525px]">
            ...
            <a class="border-none bg-transparent font-poppins text-white hover:to-blue-950 ml-1" href="login.php">
                <button class="mt-8 w-[350px] h-10 rounded-lg px-px py-3 bg-blue-700 flex justify-center items-center transition cursor-pointer">Daftar</button>
            </a>
        </div>
    </body>
</html>