    ...
    <body>
        <nav class="fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="flex items-center justify-between">
                ...
                <a href="https://flowbite.com" class="flex ms-2 md:me-24">
                    ...
                    <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">PWEB</span>
                </a>
                </div>
        ...
        <div class="p-4 sm:ml-64">
            <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
                ...
                <table class="border rounded-2xl w-full font-poppins">
                    <thead >
                        <tr>
                            <th class="border border-black p-2">ID</th>
                            <th class="border border-black p-2">Nama</th>
                            <th class="border border-black p-2">Nomor HP</th>
                            <th class="border border-black p-2 md:w-2/12 sm:w-auto">Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td class="border border-black p-2"><?= $arr['Owner'][$i] ?></td>
                                    <td class="border border-black p-2 text-center"><?= $arr['NomorHP'][$i] ?></td>
